const projectsData = {
  ...
  mitilence: {
    ...
    description:
      "Developed the Mitilence event management website, enabling users to pre-register for departmental events and providing organizers with a streamlined participant check-in process and comprehensive data management through an intuitive admin and organizer dashboard.",
  },
  devley: {
    name: "Devley",
  ...
  ridemap: {
    ...
    description:
      "Developed Ridemap V2, a React Native app with real-time bus tracking, route optimization, in-app chat, bus pass management, and an AI chatbot. This new version increased user engagement, achieving 4.2+ stars, 530+ reviews, and 10K+ downloads.",
  },
  dojo: {
    name: "Dojo 2.0",
    title: "Lucas TVS",
  ...
  fic: {
    ...
    description:
      "FrixCloud is a dynamic project that empowers users to remotely manage their local PC or server from any device, offering seamless control over programs, services, and server resources through an intuitive web dashboard.",
  },
  bvault: {
    name: "Books Vault",
    title: "Book Purchase",
    ...
    links: [
      {
        name: "github",
        url: "https://github.com/Yuvaraja28/BooksVault",
      },
    ],
    technologies: ["py", "js", "flask", "html", "css", "git", "sqlite3"],
    description:
  ...
  flick: {
    ...
    links: [
      {
        name: "github",
        url: "https://github.com/Yuvaraja28/FlickSnack",
      },
    ],
    technologies: ["express", "mongodb", "html", "tailwindcss", "js", "git"],
    description:
  ...
  tds: {
    ...
    description:
      "Developed a thermodynamics project that enables users to calculate problems related to Otto, Diesel, Brayton, and Dual Cycles by inputting valid data, providing accurate and efficient solutions for various thermodynamic cycles.",
  },
  stc: {
    active: true,
    ...
    description:
      "Developed a project to enhance communication between college management and students, allowing students to log in and access tasks assigned by staff, with a centralized dashboard for efficient task management.",
  },
  blc: {
    active: false,
    name: "Block Chat",
  ...
  dip: {
    ...
    description:
      "Developed a Spotify-inspired web application that allows users to listen to local songs through a web dashboard, providing seamless playback and control of music directly in the browser.",
  },
};
